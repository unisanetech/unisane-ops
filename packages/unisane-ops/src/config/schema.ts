...
const connectionsSchema = z
  ...
  .default({});
const targetsSchema = z.record(stableIdSchema, unisaneOpsCloudflareTargetSchema).default({});
...
export type UnisaneOpsConfigInput = z.input<typeof unisaneOpsConfigSchema>;
export type UnisaneOpsConfig = z.output<typeof unisaneOpsConfigSchema>;
...
export type UnisaneProjectConfigInput = z.input<typeof unisaneProjectConfigSchema>;
export type UnisaneProjectConfig = z.output<typeof unisaneProjectConfigSchema>;

export function defineUnisaneOps(config: UnisaneOpsConfigInput): UnisaneOpsConfig {
  return unisaneOpsConfigSchema.parse(config);
}

export function defineUnisaneProject(config: UnisaneProjectConfigInput): UnisaneProjectConfig {
