...
export const marketingProviderAvailabilitySchema = z.enum(['disabled', 'selected', 'connected']);
...
export const marketingProviderSchema = z.object({
  state: marketingProviderAvailabilitySchema.default('selected'),
...
export const marketingExecutionContextSchema = z.object({
  version: z.literal(1),
...
export type MarketingExecutionContext = z.infer<typeof marketingExecutionContextSchema>;
export type MarketingProviderAvailability = z.infer<typeof marketingProviderAvailabilitySchema>;

export function defineMarketingExecutionContext(
  context: MarketingExecutionContext,
): MarketingExecutionContext {
  return marketingExecutionContextSchema.parse(context);
}
